...
**See also:** [Mathematics — Linear Algebra](../../mathematics/01-linear-algebra/README.md) — 2×2 linear system behind the DiffDrive inverse kinematics `w_L = (v − ω·L/2)/r`, `w_R = (v + ω·L/2)/r`
