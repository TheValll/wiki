...
**See also:** [Mathematics — Linear Algebra](../../mathematics/01-linear-algebra/README.md) — Euclidean norm and weighted distance metric `d = √(Σ wᵢ(qᵢ−q'ᵢ)²)` used across C-space
