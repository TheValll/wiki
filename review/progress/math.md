...
**Current position:** 13/41 — *Complex derivatives (trig, exponential, logarithm)*
...
|---|---------|-------|-----------|
| 11 | Basic derivatives: linear, powers, inverse | 0 | 2026-04-17 |
| 12 | Chain rule (function composition) | 0 | 2026-04-17 |
| 13 | Complex derivatives: trig, exponential, logarithm | 0 | 2026-04-17 |
...
- 14. Calculation rules: sum, product, scalar multiplication ← **next**
- 15. Derivatives of quadratics and curves
- 16. Non-differentiable functions
